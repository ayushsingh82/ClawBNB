    ...
    >
      <HStack align="flex-start" spacing={6}>
        ...
        <VStack align="flex-start" spacing={2} pb={8}>
          <HStack spacing={3}>
            <Text fontWeight="black" fontSize={{ base: "lg", md: "xl" }} color="white">
              {version}
            </Text>
            <Text
              fontWeight="bold"
...
const roadmapItems: RoadmapItemProps[] = [
  {
    ...
    items: [
      "Transaction execution through NextUi API",
  ...
  },
  {
    ...
    items: [
      "Token holdings view",
      "Chat interface for NextUi prompts",
      "Custom themes",
